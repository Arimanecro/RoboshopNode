...
<div class="category cat_item_cat">
    <span><a href="/category/${data[0]["category"]}">${
  data[0]["category"]
}</a></span>
    ...
    <section class="item_block">
        <figure class="item_block__img" style="background: url(${data[0][
          "img_original"
        ].replace(/public/gi, "")}) no-repeat center;
    ...
    <form method="get" onsubmit='${e => e.preventDefault()}' id="add_tools" >
        ...
        <input name='img' type='hidden' value='${data[0]["img_small"].replace(
          /public/gi,
          ""
        )}'>
